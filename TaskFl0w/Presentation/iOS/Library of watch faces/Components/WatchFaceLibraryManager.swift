...
class WatchFaceLibraryManager: ObservableObject {
    ...
    func createCustomWatchFace(name: String) {
        ...
        let newFace = WatchFaceModel(
            ...
            isCustom: true,
            category: category,
            lightModeClockFaceColor: themeManager.lightModeClockFaceColorHex,
            darkModeClockFaceColor: themeManager.darkModeClockFaceColorHex,
            lightModeOuterRingColor: themeManager.lightModeOuterRingColorHex,
            darkModeOuterRingColor: themeManager.darkModeOuterRingColorHex,
            lightModeMarkersColor: themeManager.lightModeMarkersColorHex,
            darkModeMarkersColor: themeManager.darkModeMarkersColorHex,
